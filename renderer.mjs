...
const VERSION = "LUMI-WORLD-RENDERER-V1.0.0";
...
const VIDEO_PRESET =
  process.env.LUMI_VIDEO_PRESET ||
  "veryfast";

const VIDEO_BITRATE =
  process.env.LUMI_VIDEO_BITRATE ||
  "3000k";

const VIDEO_MAXRATE =
  process.env.LUMI_VIDEO_MAXRATE ||
  "3500k";

const VIDEO_BUFSIZE =
  process.env.LUMI_VIDEO_BUFSIZE ||
  "6000k";

const AUDIO_BITRATE =
  process.env.LUMI_AUDIO_BITRATE ||
  "128k";
...
function validateConfig() {
  if (DRY_RUN) {
    runtime.stream.configured =
      false;

    runtime.stream.target =
      "dry_run_sink";
...
function startRenderer() {
  ...
  runtime.renderer.lastExitCode =
    null;

  runtime.renderer.lastExitSignal =
    null;
